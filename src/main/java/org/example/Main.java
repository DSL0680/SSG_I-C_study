...
//            QuizData q7 = new QuizData("모두 맞히셨습니다. 1번 혹은 2번을 입력시 종료합니다", 0);
//            first.setNext(q2);
//            q2.setNext(q3);
//            q3.setNext(q4);
//            q4.setNext(q5);
...
//        System.out.println(NumGenerator.pushButton());
//        System.out.println(NumGenerator.pushButton());
//        System.out.println(NumGenerator.pushButton());
//        System.out.println(NumGenerator.pushButton());
//        System.out.println(NumGenerator.pushButton());
...
//        ScanUtil util = new ScanUtil(new Scanner(System.in));
//
//        int num = util.getInt("Number....");
//        util.print(num);
//
//        String str = util.getStr("String");
//        util.print(str);
