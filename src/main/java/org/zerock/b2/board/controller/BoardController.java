...
public class BoardController {
    ...
    public String register(
        ...
        boardRegisterDTO.setFileName(uploadedFileNames);
    ...
    public void ex2(Model model) {
        ...
        List<SampleDTO> list = List.of(
                SampleDTO.builder().name("1AAA").age(15).addr("1BBB").build(),
                SampleDTO.builder().name("2AAA").age(16).addr("2BBB").build(),
                SampleDTO.builder().name("3AAA").age(17).addr("3BBB").build(),
                SampleDTO.builder().name("4AAA").age(18).addr("4BBB").build()
        );
